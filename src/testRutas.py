...
# calcula distancia euclidiana aproximada entre nodos usando sus coordenadas
...
def run_routing_tests(G, num_pairs=3, out_csv="datos/rutas_tests.csv"):
    # prueba comparativa rápida de bfs, dfs, ucs, a*, iddfs
    print("\n[Routing] Iniciando comparativa rápida\n")
    ...
    while count < num_pairs and intentos < max_intentos:
        ...
        count += 1
        print(f"[Par {count}] Distancia aproximada: {dist_aprox:.1f} m")
    ...
    print(f"\n[Routing] Resultados guardados en {out_csv}")
